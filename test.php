...
1. **Solicitud del cliente:**  
   Cuando un usuario accede a una URL que invoca un script CGI, el servidor recibe la solicitud HTTP y detecta que debe ejecutar un programa en lugar de simplemente enviar un archivo.
